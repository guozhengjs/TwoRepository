			...
			$.ajax({
				...
				success: function (data) {
					...
					/*
                        ...
                        data
                            {"success":true/false,"cr":{备注}，“contactName":contactName}
					...
					if (data.success) {
						...
						html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>'+cName +'-${c.name}</b> <small style="color: gray;"> ' + (data.cr.createTime) + ' 由' + (data.cr.createBy) + '</small>';
...
//==================================================================
	...
	function showRemarkList() {
		...
		$.ajax({
			...
			url: "workbench/customer/getRemarkListAndContactsByCid.do",
			data: {
			...
			success: function (data) {
				/*
                    data
						...
						{"contactName":"周杰","cList":[{备注1},{2},{3}]}
                 */
				var html = "";

				var cName=data.contactsName;
				...
				$.each(data.cList, function (i, n) {
					...
					html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>'+cName+'-${c.name}</b> <small style="color: gray;" id="s' + n.id + '"> ' + (n.editFlag == 0 ? n.createTime : n.editTime) + ' 由' + (n.editFlag == 0 ? n.createBy : n.editBy) + '</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
			...
			success: function (data) {
				...
				$.each(data, function (i, n) {
					...
					/*
                        javascript:void(0);
                            将超链接禁用，只能以触发事件的形式来操作
                            href="transaction/detail.jsp"

                            onclick="window.location.href=\'workbench/contacts/detail.do?id=' + n.id + '\';"
                     */

					html += '<tr>';
					html += '<td><a onclick="window.location.href=\'workbench/transaction/detail.do?id=' + n.id + '\'; " style="text-decoration: none;">'+n.name+'</a></td>';
					html += '<td>'+n.money+'</td>';
					html += '<td>'+n.state+'</td>';
					html += '<td>'+90+'</td>';
					html += '<td>'+n.expectedDate+'</td>';
					html += '<td>'+n.type+'</td>';
					html += '<td><a href="javascript:void(0);" onclick="deletetran(\''+n.id+'\')" data-toggle="modal" data-target="#removeTransactionModal" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>删除</a></td>';
					html += '</tr>';
				...
				$.each(data, function (i, n) {
					...
					/*
                        javascript:void(0);
                            ...
                            href="workbench/contacts/detail.jsp" style="text-decoration: none;"
                     */

					html += '<tr>';
					html += '<td><a onclick="window.location.href=\'workbench/contacts/detail.do?id=' + n.id + '\';" >'+n.fullname+'</a></td>';
					html += '<td>'+n.email+'</td>';
					html += '<td>'+n.mphone+'</td>';
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 40%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						<div class="form-group">
							<label for="edit-describe" class="col-sm-2 control-label">内容12</label>
							<div class="col-sm-10" style="width: 81%;">
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button id="editBtn" type="button" class="btn btn-default" data-toggle="modal" data-target="#editCustomerModal"><span class="glyphicon glyphicon-edit"></span> 编辑12</button>
			<button id="deleteBtn" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-minus"></span> 删除33</button>
		</div>
	</div>
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				...
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					<button id="cancelBtn" type="button" class="btn btn-default">取消12</button>
					<button id="saveRemarkBtn" type="button" class="btn btn-primary">保存34</button>
				</p>
			</form>
		</div>
	</div>
