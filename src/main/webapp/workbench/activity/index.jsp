				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<label for="edit-marketActivityName" class="col-sm-2 control-label">名称123<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
		...
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel1">创建市场活动222</h4>
				</div>
				<div class="modal-body">
					...
					<form id="activityAddForm" class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="create-startTime" class="col-sm-2 control-label">开始日期11</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control time" id="create-startDate" readonly>
							</div>
							<label for="create-endTime" class="col-sm-2 control-label">结束日期12</label>
							<div class="col-sm-10" style="width: 300px;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  ...
				  <button type="button" class="btn btn-default" id="editBtn"><span class="glyphicon glyphicon-pencil"></span> 修改11</button>
